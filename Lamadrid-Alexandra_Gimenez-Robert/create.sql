...
-- para test --
INSERT INTO DOMICILIOS(CALLE, NUMERO, LOCALIDAD, PROVINCIA) VALUES ('askaban', 135, 'mordor', 'Massachusetts'), ('Calle Wallaby', 42, 'Sydney', 'Mongolia');
INSERT INTO PACIENTES(NOMBRE, APELLIDO, DNI, FECHA, DOMICILIO_ID) VALUES ('alexandra', 'caster', 11111111, '2023-02-01', 1);
INSERT INTO PACIENTES(NOMBRE, APELLIDO, DNI, FECHA, DOMICILIO_ID) VALUES ('roberto', 'lamas', 22222222, '2023-02-01', 2);
INSERT INTO ODONTOLOGOS(NOMBRE, APELLIDO, MATRICULA) VALUES ('bob', 'Sponja', 54343);TO ODONTOLOGOS (MATRICULA, NOMBRE, APELLIDO) VALUES ('4568', 'P.', 'Sherman');